    ...
    jQuery.fn.extend({
        ...
        "M_select":function(options){
            ...
            for(i=0;i<ojc_arr.length;i++){
                ...
                $ser_object.parent().parent().append('<section class="sel-box"><div class="sel-title-box"><span class="sel-title"></span><span class="sel-sign" style="position: absolute;"></span></div><section class="sel-float-box"></section></section>');
                ...
                if(!(options.Img)&&!(options.Img2)){
                    ...
                    if(options.ico==3){
                        Img="../../ecomfront/images/icons/down1.png";
                        Img2="../../ecomfront/images/icons/up1.png";
                    }
                    if(options.ico==4){
