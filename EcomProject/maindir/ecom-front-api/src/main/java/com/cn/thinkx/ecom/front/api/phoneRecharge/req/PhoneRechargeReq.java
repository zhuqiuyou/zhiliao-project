...
public class PhoneRechargeReq {
	...
	public String toString() {
		return "PhoneRechargeReq [channelOrderNo=" + channelOrderNo + ", userId=" + userId + ", phone=" + phone
				+ ", telephoneFace=" + telephoneFace + ", transAmt=" + transAmt + ", orderType=" + orderType
				+ ", reqChannel=" + reqChannel + ", callBack=" + callBack + ", attach=" + attach + ", timestamp="
				+ timestamp + ", sign=" + sign + "]";
	}
