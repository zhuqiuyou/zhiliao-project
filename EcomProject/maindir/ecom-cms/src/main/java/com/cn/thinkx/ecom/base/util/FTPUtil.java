package com.cn.thinkx.ecom.base.util;
...
public class FTPUtil {
	 ...
	 * @return
	 */
	public FTPClient ftpOpenConnect(String server, int port, String username, String password) {
	 ...
	 * @return
	 */
	public boolean uploadFileFromProduction(String server, int port, String username, String password, String pathname,
			String filename, String originfilename) {
		boolean flag = false;
		try {
	...
	public boolean uploadFileFromProduction(String server, int port, String username, String password, String pathname,
		...
		try {
			...
			InputStream inputStream = new FileInputStream(new File(originfilename));
			ftpClient = ftpOpenConnect(server, port, username, password);
			flag = uploadFile(ftpClient, pathname, fileName, inputStream);
			ftpCloseConnect(ftpClient);
		} catch (Exception e) {
			e.printStackTrace();
...
//			ftpCloseConnect(ftpClient);
	 ...
	 * @return
	 */
	public boolean downloadFile(String server, int port, String username, String password, String pathname,
