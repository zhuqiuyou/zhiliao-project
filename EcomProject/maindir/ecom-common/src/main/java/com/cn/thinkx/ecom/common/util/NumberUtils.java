...
public class NumberUtils {
	...
	/**
	 * 货品售价小计
	 * @param productPrice 货品售价（分）
	 * @param productNum 货品数量
	 * @return 商品小计
	 */
	public static BigDecimal getSubtotalAmount(String productPrice,String productNum){
		BigDecimal b1 = new BigDecimal(productPrice);
		BigDecimal b2 = new BigDecimal(productNum);
	 ...
	 * @return
	 */
	public static BigDecimal getSubtotalAmountYUAN(String productPrice,String productNum){
		BigDecimal b1 = new BigDecimal(productPrice);
		BigDecimal b2 = new BigDecimal(productNum);
		BigDecimal b3= new BigDecimal(100);
		return b1.multiply(b2).divide(b3).setScale(2, BigDecimal.ROUND_DOWN);
	}
	 ...
	 * @return BigDecimal
	 */
	public static BigDecimal RMBCentToYuanForDecimal(String money) {
		if(money==null || "".equals(money)){
			money="0";
		}
		BigDecimal b1 = new BigDecimal(money);
		BigDecimal b2 = new BigDecimal(100);
		return b1.divide(b2).setScale(2, BigDecimal.ROUND_DOWN);
	}
	 ...
	 * @return
	 */
	public static BigDecimal RMBaddMoneyToDecimal(BigDecimal b1, BigDecimal b2) {
		return b1.add(b2);
	}
...
//		System.out.println(getSubtotalAmountYUAN("99","3"));
		
		  BigDecimal realPrice=NumberUtils.RMBCentToYuanForDecimal("12600");  //订单金额
	        BigDecimal expFee=NumberUtils.RMBCentToYuanForDecimal("1000"); //配送费用
	        
	        System.out.println(NumberUtils.RMBaddMoneyToDecimal(realPrice, expFee));
	}
}
