...
var isWaring = false;
	...
	function searchCardFun() {
		...
		if(productCode && productCode!=''){
			 ...
			 $('#contractListGrid').datagrid( {	url : '${ctx}/order/cardDataGrid/300100', queryParams: $.serializeObject($('#searchCardForm'))});
		}
	}
</script>
			...
			<table class="grid">
				<tr>
					...
					<td>
						...
						<input id='orderType'  name="orderType" type="hidden"  value="300100">
