...
function searchCardFun() {
	...
	if(productCode && productCode!=''){
		 ...
		 $('#contractListGrid').datagrid( {	url : '${ctx}/order/cardDataGrid/200100', queryParams: $.serializeObject($('#searchCardForm'))});
	}
}	
		...
		<form id="orderEditForm" method="post">
			<table class="grid">
				<tr>
					...
					<td>充值金额</td>
					<td><input id ="amount" name="amount" type="text"  class="easyui-numberbox" precision="2" value="${order.amount}" data-options="required:true"  /></td>
				</tr>
			</table>
		</form>
	</div>
