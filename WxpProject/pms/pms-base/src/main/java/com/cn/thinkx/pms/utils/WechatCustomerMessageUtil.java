...
//		String content_c=String.format(WxCustomMessageUtil.WECHAT_CUSTOMER_CW10_SUCCESS,"2017年06月05日 17时14分25秒","测试商户","测试门店","10.00");
...
//	/**微信客服消息 商户端  消费成功提醒 商户端用户**/
	...
	public static final String WECHAT_CUSTOMER_W20_REFUNDORDER_FAIl="充值失败提醒：系统订单处理失败，且微信退款失败，请联系系统管理员,订单号：%s";
	...
	public static final String WECHAT_CUSTOMER_W71_REFUNDORDER_FAIL="消费提醒：系统订单处理失败，且微信退款失败，请联系系统管理员,订单号： %s";
